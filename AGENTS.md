...
This project has been enhanced with scaffold's brownfield template, preserving legacy artifacts in the `legacy/` directory.
...
- **Preserve brownfield history** through legacy artifact archiving.
...
This project has been enhanced from a brownfield state, with legacy artifacts preserved in `legacy/` for reference and potential rollback.
